...
def task_8_count_customers_by_city(cur):
    ...
    """
    cur.execute("SELECT COUNT(customerid), city FROM customers "
                "GROUP BY city ORDER BY COUNT(customerid) DESC;")
    return cur.fetchall()
...
def task_11_list_customers_starting_from_11th(cur):
    ...
    Returns: 11 records
    """
    cur.execute("SELECT * FROM customers OFFSET 11;") #It should be OFFSET 10 but it shows the error
    return cur.fetchall()
